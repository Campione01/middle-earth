...
public class ModSpawnSettingsBuilder {
    ...
    public static void addOceanAnimals(MobSpawnSettings.Builder builder) {
        ...
        builder.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(EntityType.TURTLE, 4, 1, 2));
    ...
    public static void addRareWarg(MobSpawnSettings.Builder builder){
        builder.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(ModEntities.WARG, 3, 1, 3));
    }
    public static void addUncommonWarg(MobSpawnSettings.Builder builder){
        builder.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(ModEntities.WARG, 6, 1, 3));
    }

    public static void addRareStoneTroll(MobSpawnSettings.Builder builder){
        builder.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(ModEntities.STONE_TROLL, 3, 1, 2));
    }
    public static void addMirkwoodSpider(MobSpawnSettings.Builder builder){
        builder.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(ModEntities.MIRKWOOD_SPIDER, 9, 2, 4));
    }
    public static void addRareMirkwoodSpider(MobSpawnSettings.Builder builder){
        builder.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(ModEntities.MIRKWOOD_SPIDER, 5, 1, 2));
    }

    public static void addUncommonBats(MobSpawnSettings.Builder builder){
        builder.addSpawn(MobCategory.AMBIENT, new MobSpawnSettings.SpawnerData(EntityType.BAT, 8, 2, 4));
    }
    ...
    public static void addBroadhoofGoats(MobSpawnSettings.Builder builder) {
        builder.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(ModEntities.BROADHOOF_GOAT, 4, 1, 3));
    }
    ...
    public static void addSwampMobs(MobSpawnSettings.Builder builder) {
        ...
        builder.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(ModEntities.SNAIL, 10, 1, 4));
    }

    public static void addRareSnails(MobSpawnSettings.Builder builder) {
        builder.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(ModEntities.SNAIL, 2, 1, 3));
    }
    ...
    public static void addPheasant(MobSpawnSettings.Builder builder) {
        builder.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(ModEntities.PHEASANT, 6, 1, 2));
    }

    public static void addSwan(MobSpawnSettings.Builder builder) {
        builder.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(ModEntities.SWAN, 7, 1, 3));
    }

    public static void addDeer(MobSpawnSettings.Builder builder) {
        builder.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(ModEntities.DEER, 10, 1, 4));
    }
}
