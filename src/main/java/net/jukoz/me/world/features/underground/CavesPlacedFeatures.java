...
public class CavesPlacedFeatures {
    ...
    public static final ResourceKey<PlacedFeature> ORE_GOLDEN_GREEN_TUFF = registerKey("ore_golden_green_tuff");
    ...
    public static final ResourceKey<PlacedFeature> ROOTED_AZALEA_TREE = registerKey("rooted_azalea_tree");
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> featureRegisterable) {
        ...
        Holder.Reference<ConfiguredFeature<?, ?>> oreGoldenGreenTuff = registryEntryLookup.getOrThrow(CavesConfiguredFeatures.ORE_GOLDEN_GREEN_TUFF);
        ...
        PlacementUtils.register(featureRegisterable, ORE_GOLD, goldOre, List.of(PlacementUtils.countExtra(1, 0.5f, 1), InSquarePlacement.spread(),
        ...
        PlacementUtils.register(featureRegisterable, ORE_GOLD_RARE, goldOre, List.of(PlacementUtils.countExtra(1, 0.1f, 1), InSquarePlacement.spread(),
                HeightRangePlacement.triangle(VerticalAnchor.absolute(-48), VerticalAnchor.absolute(-16)), BiomeFilter.biome()));
        PlacementUtils.register(featureRegisterable, ORE_EMERALD, emeraldOre, modifiersWithRarity(1, HeightRangePlacement.triangle(VerticalAnchor.absolute(MiddleEarthChunkGenerator.NURGON_LEVEL), VerticalAnchor.absolute(MiddleEarthChunkGenerator.DEEPSLATE_LEVEL))));
        PlacementUtils.register(featureRegisterable, ORE_MITHRIL, mithrilOre, modifiersWithRarity(3, HeightRangePlacement.triangle(VerticalAnchor.absolute(-61), VerticalAnchor.absolute(MAX_MITHRIL_HEIGHT))));
