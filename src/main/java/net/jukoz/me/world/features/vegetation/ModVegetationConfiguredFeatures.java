...
public class ModVegetationConfiguredFeatures {
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> PATCH_HOROKAKA = registerKey("patch_horokaka");
    public static final ResourceKey<ConfiguredFeature<?, ?>> PATCH_GIANT_HOROKAKA = registerKey("patch_giant_horokaka");
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> featureRegisterable) {
        ...
        FeatureUtils.register(featureRegisterable, FIELD_HEATHER, Feature.RANDOM_PATCH,
                FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK,
                        new SimpleBlockConfiguration(BlockStateProvider.simple(ModNatureBlocks.HEATHER))));
        ...
        FeatureUtils.register(featureRegisterable, PATCH_PUMICE, Feature.BLOCK_PILE,
                new BlockPileConfiguration(BlockStateProvider.simple(StoneBlockSets.PUMICE.base())));
        ...
        FeatureUtils.register(featureRegisterable, PATCH_SPIDER_EGGS, Feature.RANDOM_PATCH,
                FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK,
                        new SimpleBlockConfiguration(BlockStateProvider.simple(ModNatureBlocks.MIRKWOOD_SPIDER_EGG))));

        FeatureUtils.register(featureRegisterable, PUMICE_COLUMN, ModFeatures.CAVE_COLUMN,
                new CaveColumnFeatureConfig(ConstantInt.of(1), UniformInt.of(1, 4), StoneBlockSets.PUMICE.base().defaultBlockState()));
        FeatureUtils.register(featureRegisterable, PUMICE_COLUMN_LARGE, ModFeatures.CAVE_COLUMN,
                new CaveColumnFeatureConfig(UniformInt.of(2, 3), UniformInt.of(5, 10), StoneBlockSets.PUMICE.base().defaultBlockState()));
        ...
        FeatureUtils.register(featureRegisterable, PATCH_TALL_BULRUSH, Feature.FLOWER,
                FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK,
                        new SimpleBlockConfiguration(BlockStateProvider.simple(ModNatureBlocks.TALL_BULRUSH))));
        FeatureUtils.register(featureRegisterable, PATCH_TALL_CATTAIL, Feature.FLOWER,
                FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK,
                        new SimpleBlockConfiguration(BlockStateProvider.simple(ModNatureBlocks.TALL_CATTAILS))));
        ...
        FeatureUtils.register(featureRegisterable, PATCH_DRY_GRASS, Feature.FLOWER,
                FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK,
                        new SimpleBlockConfiguration(BlockStateProvider.simple(ModNatureBlocks.DRY_GRASS))));
        ...
        FeatureUtils.register(featureRegisterable, PATCH_DUCKWEED, Feature.RANDOM_PATCH,
                new RandomPatchConfiguration(16, 7, 3, PlacementUtils.onlyWhenEmpty(Feature.SIMPLE_BLOCK,
        ...
        FeatureUtils.register(featureRegisterable, PATCH_DEAD_HEATHER, Feature.FLOWER,
                FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK,
                        new SimpleBlockConfiguration(BlockStateProvider.simple(ModNatureBlocks.DEAD_HEATHER))));
        FeatureUtils.register(featureRegisterable, PATCH_DRY_HEATHER, Feature.FLOWER,
                FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK,
                        new SimpleBlockConfiguration(BlockStateProvider.simple(ModNatureBlocks.DRY_HEATHER))));

        FeatureUtils.register(featureRegisterable, PATCH_HOROKAKA, Feature.FLOWER,
                FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK,
                        new SimpleBlockConfiguration(BlockStateProvider.simple(ModNatureBlocks.HOROKAKA))));
        FeatureUtils.register(featureRegisterable, PATCH_GIANT_HOROKAKA, Feature.FLOWER,
                FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK,
                        new SimpleBlockConfiguration(BlockStateProvider.simple(ModNatureBlocks.GIANT_HOROKAKA))));

        FeatureUtils.register(featureRegisterable, PATCH_RED_HEATHER, Feature.FLOWER,
                FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK,
                        new SimpleBlockConfiguration(BlockStateProvider.simple(ModNatureBlocks.RED_HEATHER))));
        ...
        FeatureUtils.register(featureRegisterable, PATCH_REEDS, Feature.RANDOM_PATCH,
                new RandomPatchConfiguration(256, 12, 3, PlacementUtils.inlinePlaced(Feature.SIMPLE_BLOCK,
                        new SimpleBlockConfiguration(BlockStateProvider.simple(ModResourceItems.REEDS)),
                        BlockPredicateFilter.forPredicate(BlockPredicate.allOf(BlockPredicate.ONLY_IN_AIR_PREDICATE, BlockPredicate.wouldSurvive(ModResourceItems.REEDS.defaultBlockState(), BlockPos.ZERO),
        ...
        FeatureUtils.register(featureRegisterable, PATCH_BROWN_BOLETE_TILLER, Feature.FLOWER, new RandomPatchConfiguration(48, 6, 2,
                PlacementUtils.onlyWhenEmpty(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(new WeightedStateProvider(CavesConfiguredFeatures.getMushroomBuilder(ModNatureBlocks.BROWN_BOLETE_TILLER))))));
        ...
        FeatureUtils.register(featureRegisterable, PATCH_MORSEL_TILLER, Feature.FLOWER, new RandomPatchConfiguration(48, 6, 2,
                PlacementUtils.onlyWhenEmpty(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(new WeightedStateProvider(CavesConfiguredFeatures.getMushroomBuilder(ModNatureBlocks.MORSEL_TILLER))))));
        ...
        FeatureUtils.register(featureRegisterable, PATCH_WHITE_MUSHROOM_TILLER, Feature.FLOWER, new RandomPatchConfiguration(48, 6, 2,
                PlacementUtils.onlyWhenEmpty(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(new WeightedStateProvider(CavesConfiguredFeatures.getMushroomBuilder(ModNatureBlocks.WHITE_MUSHROOM_TILLER))))));
        // endregion
