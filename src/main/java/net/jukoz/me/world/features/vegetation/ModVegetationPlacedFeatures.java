...
public class ModVegetationPlacedFeatures {
    ...
    public static final ResourceKey<PlacedFeature> PATCH_HOROKAKA = registerKey("patch_horokaka");
    public static final ResourceKey<PlacedFeature> PATCH_GIANT_HOROKAKA = registerKey("patch_giant_horokaka");
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> featureRegisterable) {
        ...
        Holder.Reference<ConfiguredFeature<?, ?>> horokaka = registryEntryLookup.getOrThrow(ModVegetationConfiguredFeatures.PATCH_HOROKAKA);
        Holder.Reference<ConfiguredFeature<?, ?>> giantHorokaka = registryEntryLookup.getOrThrow(ModVegetationConfiguredFeatures.PATCH_GIANT_HOROKAKA);
        ...
        PlacementUtils.register(featureRegisterable, FLOWER_ALLIUM, flowerAllium, sparse, InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome());
        ...
        PlacementUtils.register(featureRegisterable, FLOWER_ELANOR, flowerElanor, sparse, InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome());
        ...
        PlacementUtils.register(featureRegisterable, PATCH_SHORT_CATTAIL, shortCattail, scarce, InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome());
        PlacementUtils.register(featureRegisterable, PATCH_TALL_CATTAIL, tallCattail, scarce, InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome());
        PlacementUtils.register(featureRegisterable, PATCH_SHORT_BULRUSH, shortBulrush, scarce, InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome());
        PlacementUtils.register(featureRegisterable, PATCH_TALL_BULRUSH, tallBulrush, scarce, InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome());
        ...
        PlacementUtils.register(featureRegisterable, PATCH_DUCKWEED, duckweed, abundant, InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome());
        ...
        PlacementUtils.register(featureRegisterable, PATCH_HOROKAKA, horokaka, veryRare, InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome());
        PlacementUtils.register(featureRegisterable, PATCH_GIANT_HOROKAKA, giantHorokaka, wildBushRarity, InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome());
        ...
        PlacementUtils.register(featureRegisterable, PATCH_REEDS, reeds, CountPlacement.of(1), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome());
