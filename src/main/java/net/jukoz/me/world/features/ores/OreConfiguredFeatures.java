...
public class OreConfiguredFeatures {
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> featureRegisterable) {
        ...
        BlockMatchTest ashenStoneTest = new BlockMatchTest(StoneBlockSets.ASHEN_STONE.base());
        ...
        FeatureUtils.register(featureRegisterable, BLUE_TUFF_ORE, Feature.ORE,
                new OreConfiguration(stoneTest, StoneBlockSets.BLUE_TUFF.base().defaultBlockState(), 64));
        ...
        FeatureUtils.register(featureRegisterable, DOLOMITE_ORE, Feature.ORE,
                new OreConfiguration(stoneTest, StoneBlockSets.DOLOMITE.base().defaultBlockState(), 64, 0.25f));
        ...
        FeatureUtils.register(featureRegisterable, GONLUIN_GRASS_ORE, Feature.DISK,
                new DiskConfiguration(RuleBasedBlockStateProvider.simple(Blocks.GRASS_BLOCK),
                        BlockPredicate.matchesBlocks(List.of(StoneBlockSets.GONLUIN.base())), UniformInt.of(3, 6), 1));
        ...
        FeatureUtils.register(featureRegisterable, LIMESTONE_ORE, Feature.ORE,
                new OreConfiguration(stoneTest, StoneBlockSets.LIMESTONE.base().defaultBlockState(), 64, 0.25f));
