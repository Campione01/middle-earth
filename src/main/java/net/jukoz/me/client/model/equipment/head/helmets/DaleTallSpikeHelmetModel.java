...
public class DaleTallSpikeHelmetModel<T extends LivingEntity> extends HelmetAddonModel<T> {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition addon = head.addOrReplaceChild("addon", CubeListBuilder.create()
                .texOffs(0, 0).addBox(-5.0F, -6.7F, -5.0F, 10.0F, 2.0F, 10.0F, new CubeDeformation(0.2F))
                .texOffs(37, 0).addBox(-2.5F, -11.5F, -3.0F, 5.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

        addon.addOrReplaceChild("spike_tall", CubeListBuilder.create().texOffs(6, 0).addBox(-0.5F, -3.5F, -0.5F, 1.0F, 8.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -12.5F, 0.0F, 0.0F, -0.7854F, 0.0F));
