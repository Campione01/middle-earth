...
public class SalletHelmetAddonModel<T extends LivingEntity> extends HelmetAddonModel<T> {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        head.addOrReplaceChild("sallet", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -2.8F, 4.654F, 8.0F, 1.0F, 2.0F, new CubeDeformation(0.22F)), PartPose.offset(0.0F, 0.0F, 0.0F));
