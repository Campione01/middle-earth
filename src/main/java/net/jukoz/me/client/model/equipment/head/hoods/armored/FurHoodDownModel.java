...
public class FurHoodDownModel<T extends LivingEntity> extends CloakHoodModel<T> {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition hood = hat.addOrReplaceChild("hood", CubeListBuilder.create().texOffs(0, 73).addBox(-4.0F, -9.0F, -4.376F, 8.0F, 5.0F, 2.0F, new CubeDeformation(0.1F)), PartPose.offset(0.0F, -0.0F, 0.0F));

        PartDefinition furHood = hood.addOrReplaceChild("fur_hood", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -6.5F, -3.5F, 1.5708F, 0.0F, 0.0F));
