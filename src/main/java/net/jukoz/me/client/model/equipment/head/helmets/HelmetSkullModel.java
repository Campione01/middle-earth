...
public class HelmetSkullModel<T extends LivingEntity> extends HelmetAddonModel<T> {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        head.addOrReplaceChild("skull_parts", CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -41.0F, -3.0F, 6.0F, 7.0F, 6.0F, new CubeDeformation(0.0F))
                .texOffs(0, 13).addBox(-3.0F, -41.0F, -3.0F, 6.0F, 7.0F, 6.0F, new CubeDeformation(0.2F))
                .texOffs(24, 0).addBox(-3.0F, -41.0F, -3.0F, 6.0F, 9.0F, 6.0F, new CubeDeformation(0.4F))
                .texOffs(36, 53).addBox(-0.5F, -43.0F, -0.5F, 1.0F, 10.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(40, 60).addBox(-5.0F, -39.3F, -1.0F, 10.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 25.0F, 0.0F));
