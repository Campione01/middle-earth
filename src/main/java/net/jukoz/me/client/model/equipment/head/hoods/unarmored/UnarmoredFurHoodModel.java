...
public class UnarmoredFurHoodModel<T extends LivingEntity> extends CloakHoodModel<T> {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        hat.addOrReplaceChild("fur_hood", CubeListBuilder.create()
                .texOffs(0, 73).addBox(-4.0F, -8.0F, -4.45F, 8.0F, 5.0F, 2.0F, new CubeDeformation(0.1F))
                .texOffs(32, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.9F))
                .texOffs(0, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.6F)), PartPose.offsetAndRotation(0.0F, 0.0F, -0.0F, -0.0F, 0.0F, 0.0F));

        PartDefinition hood = hat.addOrReplaceChild("hood", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.14F, 2.65F, -0.0F, -0.0F, 0.0F, 0.0F));

        hood.addOrReplaceChild("top", CubeListBuilder.create()
                .texOffs(112, 29).addBox(-2.872F, -11.2857F, -5.3F, 6.0F, 1.0F, 2.0F, new CubeDeformation(0.5F))
        ...
        hood.addOrReplaceChild("bottom", CubeListBuilder.create()
                .texOffs(112, 20).addBox(-2.75F, -2.2857F, -5.3F, 6.0F, 1.0F, 2.0F, new CubeDeformation(0.5F))
        ...
        hood.addOrReplaceChild("left", CubeListBuilder.create()
                .texOffs(100, 20).addBox(3.6F, -11.2857F, -5.3F, 1.0F, 10.0F, 2.0F, new CubeDeformation(0.5F))
                .texOffs(94, 20).addBox(3.6F, -11.2857F, -5.3F, 1.0F, 10.0F, 2.0F, new CubeDeformation(0.59F)), PartPose.offset(0.0F, 0.0F, 0.0F));

        hood.addOrReplaceChild("right", CubeListBuilder.create()
                .texOffs(100, 20).mirror().addBox(-4.35F, -11.2857F, -5.3F, 1.0F, 10.0F, 2.0F, new CubeDeformation(0.5F)).mirror(false)
                .texOffs(106, 20).addBox(-4.35F, -11.2857F, -5.3F, 1.0F, 10.0F, 2.0F, new CubeDeformation(0.59F)), PartPose.offset(-0.0F, 0.0F, 0.0F));
