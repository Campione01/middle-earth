...
public class HatArmorAddonModel<T extends LivingEntity> extends HelmetAddonModel<T> {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        head.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(-6, 0).addBox(-8.0F, -4.2F, -8.0F, 16.0F, 0.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition feathers = head.addOrReplaceChild("feathers", CubeListBuilder.create(), PartPose.offsetAndRotation(3.9823F, -10.002F, 0.7141F, -0.0393F, 0.0F, 0.0F));
        feathers.addOrReplaceChild("feather", CubeListBuilder.create().texOffs(2, 41).addBox(1.5F, -4.8F, -6.5F, 0.0F, 8.0F, 10.0F, new CubeDeformation(1.0F)), PartPose.offsetAndRotation(0.3037F, 1.402F, 1.6859F, 0.1327F, 0.0379F, 0.0433F));
