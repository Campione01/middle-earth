...
public class LorienHelmetArmorAddonModel<T extends LivingEntity> extends HelmetAddonModel<T> {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        head.addOrReplaceChild("spike", CubeListBuilder.create().texOffs(0, 33).addBox(-5.0F, 0.5F, 0.5F, 0.0F, 5.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.0F, -4.0F, -8.0F, 1.5708F, 0.0F, 0.0F));
