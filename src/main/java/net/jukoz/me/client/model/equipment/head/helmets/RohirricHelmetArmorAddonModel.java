...
public class RohirricHelmetArmorAddonModel<T extends LivingEntity> extends HelmetAddonModel<T> {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition head = modelPartData.addOrReplaceChild(PartNames.HEAD, CubeListBuilder.create().texOffs(30, 17)
                .addBox(0.0F, -14.5F, -9.5F, 0.0F, 11.0F, 17.0F, new CubeDeformation(0.0F)),
                PartPose.offset(0.0F, -1.0F, 0.0F));

        head.addOrReplaceChild("hair", CubeListBuilder.create().texOffs(0, 27)
                        .addBox(-1.0F, -2.0F, 0.0F, 2.0F, 3.0F, 18.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(0.0F, -9.0F, 5.0F, -1.5708F, 0.0F, 0.0F));
    ...
    public void setupAnim(T entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        ...
        this.hair.xRot = ToRad.ex(degree);
    }
}