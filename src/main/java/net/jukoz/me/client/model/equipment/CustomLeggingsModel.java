...
public class CustomLeggingsModel<T extends LivingEntity> extends HumanoidModel<T> {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        body.addOrReplaceChild("waist", CubeListBuilder.create().texOffs(16, 16).addBox(-3.9F, -0.0F, -2.1F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.3F)),
        ...
        modelPartData.addOrReplaceChild(PartNames.RIGHT_LEG, CubeListBuilder.create().texOffs(0, 16).addBox(-2.1F, -1.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.3F)), PartPose.offset(-1.9F, -11.0F, 0.0F));
        modelPartData.addOrReplaceChild(PartNames.LEFT_LEG, CubeListBuilder.create().texOffs(0, 32).mirror().addBox(-1.968F, -1.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.3F)).mirror(false), PartPose.offset(1.9F, -11.0F, 0.0F));
