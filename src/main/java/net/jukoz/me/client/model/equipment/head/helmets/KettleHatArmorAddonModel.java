...
public class KettleHatArmorAddonModel<T extends LivingEntity> extends HelmetAddonModel<T> {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        head.addOrReplaceChild("kettle_hat", CubeListBuilder.create()
                .texOffs(0, 0).addBox(-7.0F, -8.1F, -7.0F, 14.0F, 1.0F, 14.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 2.766F, 0.0F));
