...
public class EreborHelmetModel<T extends LivingEntity> extends HelmetAddonModel<T> {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        head.addOrReplaceChild("eye_addon", CubeListBuilder.create().texOffs(46, 63).addBox(-4.5F, -3.5F, -4.5F, 9.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
