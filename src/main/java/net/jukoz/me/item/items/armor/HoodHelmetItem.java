...
public class HoodHelmetItem extends ArmorItem implements MEEquipmentTooltip {
    ...
    public HoodHelmetItem(Properties settings, ExtendedArmorMaterial armorMaterial, ModFactions faction) {
    ...
    public HoodHelmetItem(Properties settings, ExtendedArmorMaterial armorMaterial, ModSubFactions subFaction) {
        super(armorMaterial.material(), Type.HELMET, settings
                .stacksTo(1)
                .durability(Type.CHESTPLATE.getDurability(armorMaterial.durabilityModifier())));
