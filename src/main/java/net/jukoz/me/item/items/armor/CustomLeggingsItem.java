...
public class CustomLeggingsItem extends ArmorItem implements MEEquipmentTooltip {
    ...
    public CustomLeggingsItem(ExtendedArmorMaterial material, Properties settings, ModFactions faction) {
        super(material.material(), ArmorItem.Type.LEGGINGS, settings.stacksTo(1).durability(Type.BOOTS.getDurability(material.durabilityModifier())));
    ...
    public CustomLeggingsItem(ExtendedArmorMaterial material, Properties settings, ModSubFactions subFaction) {
        super(material.material(), ArmorItem.Type.LEGGINGS, settings.stacksTo(1).durability(Type.BOOTS.getDurability(material.durabilityModifier())));
