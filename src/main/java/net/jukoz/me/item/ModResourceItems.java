...
public class ModResourceItems {
    public static final Item MIDDLE_EARTH_MAP = registerItem("middle_earth_map",
            new MiddleEarthMapItem(new Item.Properties().stacksTo(1)));

    public static final Item EMPTY_PHIAL = registerItem("empty_phial",
            new EmptyPhialItem(new Item.Properties()));
    ...
    public static final Item STARLIGHT_PHIAL = registerItem("starlight_phial",
            new StarlightPhialItem(new Item.Properties().stacksTo(1)));
    ...
    public static final Item BURZUM_STEEL_INGOT = registerItem("burzum_steel_ingot",
            new SmithingMaterialItem(new Item.Properties()));
    ...
    public static final Item LIT_PINECONE = registerItem("lit_pinecone",
            new LitPineconeItem(new Item.Properties().stacksTo(16)));

    public static final Item STRAW = registerItem("straw",
            new Item(new Item.Properties()));
    public static final Block REEDS = registerBlock("reeds",
            new CustomWaterloggableTallPlantBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.TALL_GRASS).instabreak(), false), false);
    ...
    public static final Item GLOWWORM_BOTTLE = registerItem("glowworm_bottle",
            new GlowwormBottle(new Item.Properties().stacksTo(1).food(
                    new FoodProperties.Builder().nutrition(2).saturationModifier(0.3f).alwaysEdible().build()).craftRemainder(Items.GLASS_BOTTLE)));

    public static final Item COPPER_COIN = registerItem("copper_coin", new Item(new Item.Properties()));
    public static final Item SILVER_COIN = registerItem("silver_coin", new Item(new Item.Properties()));
    public static final Item GOLD_COIN = registerItem("gold_coin", new Item(new Item.Properties()));

    public static final Item FLAX = registerItem("flax", new Item(new Item.Properties()));
    public static final Item FLAX_SEEDS = registerItem("flax_seeds", new ItemNameBlockItem(ModNatureBlocks.FLAX_CROP, new Item.Properties()));
    public static final Item PIPEWEED = registerItem("pipeweed", new Item(new Item.Properties()));
    public static final Item DRIED_PIPEWEED = registerItem("dried_pipeweed", new Item(new Item.Properties()));
    public static final Item PIPEWEED_SEEDS = registerItem("pipeweed_seeds", new ItemNameBlockItem(ModNatureBlocks.PIPEWEED_CROP, new Item.Properties()));


    public static final Item TOMATO_SEEDS = registerItem("tomato_seeds", new ItemNameBlockItem(ModNatureBlocks.TOMATO_CROP, new Item.Properties()));
    public static final Item BELL_PEPPER_SEEDS = registerItem("bell_pepper_seeds", new ItemNameBlockItem(ModNatureBlocks.BELL_PEPPER_CROP, new Item.Properties()));
    public static final Item CUCUMBER_SEEDS = registerItem("cucumber_seeds", new ItemNameBlockItem(ModNatureBlocks.CUCUMBER_CROP, new Item.Properties()));
    public static final Item LETTUCE_SEEDS = registerItem("lettuce_seeds", new ItemNameBlockItem(ModNatureBlocks.LETTUCE_CROP, new Item.Properties()));
    ...
    public static final Item PICKAXE_HEAD = registerItem("pickaxe_head",
            new SmithingMaterialItem(new Item.Properties().stacksTo(16)));
    ...
    public static final Item MAIL_RING = registerItem("mail_ring",
            new SmithingMaterialItem(new Item.Properties().stacksTo(64)));
    ...
    public static final Item PIPEWEED_BANNER_PATTERN = registerItem("pipeweed_banner_pattern",
            new BannerPatternItem(ModBannerPatternTags.PIPEWEED_PATTERN_ITEM, new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final Item GONDOR_BANNER_PATTERN = registerItem("gondor_banner_pattern",
            new BannerPatternItem(ModBannerPatternTags.GONDOR_PATTERN_ITEM, new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final Item ROHAN_BANNER_PATTERN = registerItem("rohan_banner_pattern",
            new BannerPatternItem(ModBannerPatternTags.ROHAN_PATTERN_ITEM, new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final Item LOTHLORIEN_BANNER_PATTERN = registerItem("lothlorien_banner_pattern",
            new BannerPatternItem(ModBannerPatternTags.LOTHLORIEN_PATTERN_ITEM, new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final Item MORDOR_BANNER_PATTERN = registerItem("mordor_banner_pattern",
            new BannerPatternItem(ModBannerPatternTags.MORDOR_PATTERN_ITEM, new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final Item MISTY_MOUNTAINS_ORCS_BANNER_PATTERN = registerItem("misty_mountains_orcs_banner_pattern",
            new BannerPatternItem(ModBannerPatternTags.MISTY_MOUNTAINS_ORCS_PATTERN_ITEM, new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final Item ISENGARD_BANNER_PATTERN = registerItem("isengard_banner_pattern",
            new BannerPatternItem(ModBannerPatternTags.ISENGARD_PATTERN_ITEM, new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));

    public static final Item ANVIL_BANNER_PATTERN = registerItem("anvil_banner_pattern",
            new BannerPatternItem(ModBannerPatternTags.ANVIL_PATTERN_ITEM, new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final Item BELL_BANNER_PATTERN = registerItem("bell_banner_pattern",
            new BannerPatternItem(ModBannerPatternTags.BELL_PATTERN_ITEM, new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final Item BOW_BANNER_PATTERN = registerItem("bow_banner_pattern",
            new BannerPatternItem(ModBannerPatternTags.BOW_PATTERN_ITEM, new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));

    public static final Item DWARF_CROWN_BANNER_PATTERN = registerItem("dwarf_crown_banner_pattern",
            new BannerPatternItem(ModBannerPatternTags.DWARF_CROWN_PATTERN_ITEM, new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));

    public static final Item DRAGON_BANNER_PATTERN = registerItem("dragon_banner_pattern",
            new BannerPatternItem(ModBannerPatternTags.DRAGON_PATTERN_ITEM, new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)));
    public static final Item SNAIL_BANNER_PATTERN = registerItem("snail_banner_pattern",
            new BannerPatternItem(ModBannerPatternTags.SNAIL_PATTERN_ITEM, new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)));
    ...
    static Item registerBlockItem(String name, Block block) {
        ...
        ModItemGroups.RESOURCES_CONTENTS.add(item.getDefaultInstance());
        return item;
    }
