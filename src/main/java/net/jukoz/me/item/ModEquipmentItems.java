...
public class ModEquipmentItems {
    ...
    public static final Item HOOD = registerDyeableHood("hood",
            new HoodHelmetItem(new Item.Properties()
    ...
    public static final Item CAPE = registerDyeableCape("cape",
            new CapeChestplateItem(new Item.Properties()
    ...
    public static final Item STRAW_HAT = registerCustomModelArmorPiece("straw_hat",
            new CustomHelmetItem(ModArmorMaterials.STRAW_T1, new Item.Properties(),
                    ModFactions.NONE));

    public static final Item WOVEN_HAT = registerCustomModelArmorPiece("woven_hat",
            new CustomHelmetItem(ModArmorMaterials.WOOL_T1, new Item.Properties(),
                    ModFactions.NONE));
    ...
    public static final Item WANDERER_HAT = registerDyeableCustomModelArmorPiece("wanderer_hat",
            new CustomHelmetItem(ModArmorMaterials.FABRIC_T1, new Item.Properties()
                    .component(ModDataComponentTypes.DYE_DATA, new CustomDyeableDataComponent(5394247)),
                    ModFactions.NONE));

    public static final Item ARMING_COAT = registerDyeableArmorPiece("arming_coat",
            new CustomChestplateItem(ModArmorMaterials.FABRIC_T1, new Item.Properties()
    ...
    public static final Item ARMING_SKIRT = registerDyeableArmorPiece("arming_skirt",
            new CustomLeggingsItem(ModArmorMaterials.FABRIC_T1, new Item.Properties()
                    .component(ModDataComponentTypes.DYE_DATA, new CustomDyeableDataComponent(15256475)),
                    ModFactions.NONE));

    public static final Item SHOES = registerArmorPiece("shoes",
            new CustomBootsItem(ModArmorMaterials.FABRIC_T1, new Item.Properties(),
                    ModFactions.NONE));
    ...
    public static final Item LEATHER_SKULLCAP = registerDyeableArmorPiece("leather_skullcap",
            new CustomHelmetItem(ModArmorMaterials.LEATHER_T2, new Item.Properties()
                    .component(ModDataComponentTypes.DYE_DATA, new CustomDyeableDataComponent(-6265536)),
                    ModFactions.NONE));
    ...
    public static final Item KETTLE_HAT = registerCustomModelArmorPiece("kettle_hat",
            new CustomHelmetItem(ModArmorMaterials.IRON_T2, new Item.Properties(),
                    ModFactions.NONE));

    public static final Item GAMBESON = registerDyeableArmorPiece("gambeson",
            new CustomChestplateItem(ModArmorMaterials.LEATHER_T2, new Item.Properties()
                    .component(ModDataComponentTypes.DYE_DATA, new CustomDyeableDataComponent(15256475)),
                    ModFactions.NONE));
    ...
    public static final Item STURDY_BOOTS = registerArmorPiece("sturdy_boots",
            new CustomBootsItem(ModArmorMaterials.LEATHER_T2, new Item.Properties(),
                    ModFactions.NONE));
    ...
    public static final Item MAIL_COIF = registerArmorPiece("mail_coif",
            new CustomHelmetItem(ModArmorMaterials.IRON_T3, new Item.Properties(),
                    ModFactions.NONE));
    ...
    public static final Item MAIL_HAUBERK = registerArmorPiece("mail_hauberk",
            new CustomChestplateItem(ModArmorMaterials.IRON_T3, new Item.Properties(),
                    ModFactions.NONE));
    ...
    public static final Item MAIL_SKIRT = registerArmorPiece("mail_skirt",
            new CustomLeggingsItem(ModArmorMaterials.IRON_T3, new Item.Properties(),
                    ModFactions.NONE));

    public static final Item SALLET = registerCustomModelArmorPiece("sallet",
            new CustomHelmetItem(ModArmorMaterials.STEEL_T4, new Item.Properties(),
                    ModFactions.NONE));
    //endregion

    //region HOBBITS
    public static final Item SHIRRIFF_HAT = registerDyeableCustomModelArmorPiece("shirriff_hat",
            new CustomHelmetItem(ModArmorMaterials.LEATHER_T1, new Item.Properties()
    ...
    public static final Item GONDORIAN_HORSE_ARMOR = registerGeneratedItem("gondorian_horse_armor",
            new CustomHorseArmorItem(ModArmorMaterials.GONDORIAN_HORSE_ARMOR.material(), AnimalArmorItem.BodyType.EQUESTRIAN, false, new Item.Properties().stacksTo(1), ModFactions.GONDOR));
    ...
    public static final Item ROHIRRIC_SCALE_JACKET = registerArmorPiece("rohirric_scale_jacket",
            new CustomLeggingsItem(ModArmorMaterials.STEEL_T4, new Item.Properties(),
                    ModFactions.ROHAN));
    ...
    public static final Item ROHIRRIC_HORSE_ARMOR = registerGeneratedItem("rohirric_horse_armor",
            new CustomHorseArmorItem(ModArmorMaterials.ROHIRRIC_HORSE_ARMOR.material(), AnimalArmorItem.BodyType.EQUESTRIAN, false, new Item.Properties().stacksTo(1), ModFactions.ROHAN));
    //endregion
    ...
    public static final Item DALISH_HEYDAY_BOOTS = registerArmorPiece("dalish_heyday_boots",
            new CustomBootsItem(ModArmorMaterials.STEEL_T4, new Item.Properties(),
                    ModFactions.DALE));
    ...
    public static final Item DALISH_HORSE_ARMOR = registerGeneratedItem("dalish_horse_armor",
            new CustomHorseArmorItem(ModArmorMaterials.DALISH_HORSE_ARMOR.material(), AnimalArmorItem.BodyType.EQUESTRIAN, false, new Item.Properties().stacksTo(1), ModFactions.DALE));
    ...
    public static final Item DWARVEN_MAIL_CHAUSSES = registerArmorPiece("dwarven_mail_chausses",
            new CustomBootsItem(ModArmorMaterials.IRON_T3, new Item.Properties(),
                    ModFactions.NONE));
    ...
    public static final Item DWARVEN_SCALE_HAUBERK = registerArmorPiece("dwarven_scale_hauberk",
            new CustomChestplateItem(ModArmorMaterials.DWARVEN_STEEL_T4, new Item.Properties(),
                    ModFactions.NONE));

    public static final Item DWARVEN_SCALE_COAT = registerArmorPiece("dwarven_scale_coat",
            new CustomLeggingsItem(ModArmorMaterials.DWARVEN_STEEL_T4, new Item.Properties(),
                    ModFactions.NONE));

    public static final Item DWARVEN_REINFORCED_BOOTS = registerArmorPiece("dwarven_reinforced_boots",
            new CustomBootsItem(ModArmorMaterials.DWARVEN_STEEL_T4, new Item.Properties(),
                    ModFactions.NONE));
    //endregion

    //region LONGBEARDS
    public static final Item LONGBEARD_SEGMENTED_HELMET = registerArmorPiece("longbeard_segmented_helmet",
            new CustomHelmetItem(ModArmorMaterials.BRONZE_T2, new Item.Properties(),
    ...
    public static final Item LONGBEARD_LEATHER_LEGGINGS = registerDyeableArmorPiece("longbeard_leather_leggings",
            new CustomLeggingsItem(ModArmorMaterials.LEATHER_T2, new Item.Properties()
                    .component(ModDataComponentTypes.DYE_DATA, new CustomDyeableDataComponent(5914168)),
                    ModFactions.LONGBEARDS));
    ...
    public static final Item RAVENHILL_HELMET = registerArmorPiece("ravenhill_helmet",
            new CustomHelmetItem(ModArmorMaterials.DWARVEN_STEEL_T4, new Item.Properties(),
                    ModSubFactions.EREBOR));
    ...
    public static final Item EREBOR_GUARD_HELMET = registerArmorPiece("erebor_guard_helmet",
            new CustomHelmetItem(ModArmorMaterials.DWARVEN_STEEL_T5, new Item.Properties(),
                    ModSubFactions.EREBOR));
    ...
    public static final Item EREBOR_PLATE_CHESTPLATE = registerCustomModelArmorPiece("erebor_plate_chestplate",
            new CustomChestplateItem(ModArmorMaterials.DWARVEN_STEEL_T5, new Item.Properties(),
                    ModSubFactions.EREBOR));
    public static final Item EREBOR_PLATE_LEGGINGS = registerArmorPiece("erebor_plate_leggings",
            new CustomLeggingsItem(ModArmorMaterials.DWARVEN_STEEL_T5, new Item.Properties(),
                    ModSubFactions.EREBOR));
    public static final Item EREBOR_PLATE_BOOTS = registerArmorPiece("erebor_plate_boots",
            new CustomBootsItem(ModArmorMaterials.DWARVEN_STEEL_T5, new Item.Properties(),
                    ModSubFactions.EREBOR));
    ...
    public static final Item LORIEN_DIADEM = registerCustomModelArmorPiece("lorien_diadem",
            new CustomHelmetItem(ModArmorMaterials.BRONZE_T1, new Item.Properties(),
    ...
    public static final Item LORIEN_SOLDIER_HELMET = registerCustomModelArmorPiece("lorien_soldier_helmet",
            new CustomHelmetItem(ModArmorMaterials.ELVEN_STEEL_T4, new Item.Properties(),
                    ModFactions.LOTHLORIEN));

    public static final Item LORIEN_SOLDIER_MAIL_HAUBERK = registerArmorPiece("lorien_soldier_mail_hauberk",
            new CustomChestplateItem(ModArmorMaterials.ELVEN_STEEL_T4, new Item.Properties(),
                    ModFactions.LOTHLORIEN));
    ...
    public static final Item LORIEN_SCALE_COAT = registerArmorPiece("lorien_scale_coat",
            new CustomLeggingsItem(ModArmorMaterials.ELVEN_STEEL_T4, new Item.Properties(),
                    ModFactions.LOTHLORIEN));

    public static final Item GALADHRIM_HELMET = registerCustomModelArmorPiece("galadhrim_helmet",
            new CustomHelmetItem(ModArmorMaterials.ELVEN_STEEL_T5, new Item.Properties()
    ...
    public static final Item GALADHRIM_CHESTPLATE = registerArmorPiece("galadhrim_chestplate",
            new CustomChestplateItem(ModArmorMaterials.ELVEN_STEEL_T5, new Item.Properties()
    ...
    public static final Item GALADHRIM_LEGGINGS = registerArmorPiece("galadhrim_leggings",
            new CustomLeggingsItem(ModArmorMaterials.ELVEN_STEEL_T5, new Item.Properties(),
                    ModFactions.LOTHLORIEN));
    public static final Item GALADHRIM_BOOTS = registerArmorPiece("galadhrim_boots",
            new CustomBootsItem(ModArmorMaterials.ELVEN_STEEL_T5, new Item.Properties(),
                    ModFactions.LOTHLORIEN));
    ...
    public static final Item LORIEN_HORSE_ARMOR = registerGeneratedItem("lorien_horse_armor",
            new CustomHorseArmorItem(ModArmorMaterials.LORIEN_HORSE_ARMOR.material(), AnimalArmorItem.BodyType.EQUESTRIAN, false, new Item.Properties().stacksTo(1), ModFactions.LOTHLORIEN));
    ...
    public static final Item ORCISH_LEATHER_STRAP = registerDyeableArmorPiece("orcish_leather_strap",
            new CustomChestplateItem(ModArmorMaterials.LEATHER_T1, new Item.Properties()
    ...
    public static final Item RUSTED_ORCISH_MAIL_HAUBERK = registerArmorPiece("rusted_orcish_mail_hauberk",
            new CustomChestplateItem(ModArmorMaterials.IRON_T2, new Item.Properties(),
                    ModFactions.NONE));
    ...
    public static final Item RUSTED_ORCISH_MAIL_COAT = registerArmorPiece("rusted_orcish_mail_coat",
            new CustomLeggingsItem(ModArmorMaterials.IRON_T2, new Item.Properties(),
                    ModFactions.NONE));
    ...
    public static final Item ORCISH_SALLET = registerCustomModelArmorPiece("orcish_sallet",
            new CustomHelmetItem(ModArmorMaterials.BURZUM_STEEL_T4, new Item.Properties(),
                    ModFactions.NONE));

    public static final Item ORCISH_BELLY_PLATE_CHESTPLATE = registerDyeableArmorPiece("orcish_belly_plate_chestplate",
            new CustomChestplateItem(ModArmorMaterials.BURZUM_STEEL_T4, new Item.Properties()
                    .component(ModDataComponentTypes.DYE_DATA, new CustomDyeableDataComponent(4865076)),
                    ModFactions.NONE));
    ...
    public static final Item ORCISH_REINFORCED_LEG_BRACER = registerArmorPiece("orcish_reinforced_leg_bracer",
            new CustomLeggingsItem(ModArmorMaterials.BURZUM_STEEL_T4, new Item.Properties(),
                    ModFactions.NONE));

    public static final Item ORCISH_BRACED_SANDALS = registerDyeableArmorPiece("orcish_braced_sandals",
            new CustomBootsItem(ModArmorMaterials.BURZUM_STEEL_T4, new Item.Properties()
                    .component(ModDataComponentTypes.DYE_DATA, new CustomDyeableDataComponent(4865076)),
                    ModFactions.NONE));
    ...
    public static final Item RUSTED_MORDOR_HELMET = registerArmorPiece("rusted_mordor_helmet",
            new CustomHelmetItem(ModArmorMaterials.CRUDE_T2, new Item.Properties(),
                    ModFactions.MORDOR));
    ...
    public static final Item MORDOR_HELMET = registerArmorPiece("mordor_helmet",
            new CustomHelmetItem(ModArmorMaterials.CRUDE_T3, new Item.Properties(),
                    ModFactions.MORDOR));
    ...
    public static final Item RUSTED_MORDOR_CREST_HELMET = registerCustomModelArmorPiece("rusted_mordor_crest_helmet",
            new CustomHelmetItem(ModArmorMaterials.BURZUM_STEEL_T3, new Item.Properties(),
                    ModFactions.MORDOR));
    ...
    public static final Item RUSTED_MORDOR_CHESTPLATE = registerArmorPiece("rusted_mordor_chestplate",
            new CustomChestplateItem(ModArmorMaterials.BURZUM_STEEL_T3, new Item.Properties(),
                    ModFactions.MORDOR));
    ...
    public static final Item RUSTED_MORDOR_PLATE_BOOTS = registerArmorPiece("rusted_mordor_plate_boots",
            new CustomBootsItem(ModArmorMaterials.BURZUM_STEEL_T3, new Item.Properties(),
                    ModFactions.MORDOR));
    ...
    public static final Item MORDOR_GREAT_HELMET = registerCustomModelArmorPiece("mordor_great_helmet",
            new CustomHelmetItem(ModArmorMaterials.BURZUM_STEEL_T5, new Item.Properties(),
                    ModFactions.MORDOR));
    ...
    public static final Item BLACK_URUK_PLATE_CHESTPLATE = registerCustomModelArmorPiece("black_uruk_plate_chestplate",
            new CustomChestplateItem(ModArmorMaterials.BURZUM_STEEL_T5, new Item.Properties(),
                    ModFactions.MORDOR));
    public static final Item BLACK_URUK_PLATE_LEGGINGS = registerArmorPiece("black_uruk_plate_leggings",
            new CustomLeggingsItem(ModArmorMaterials.BURZUM_STEEL_T5, new Item.Properties(),
                    ModFactions.MORDOR));
    public static final Item BLACK_URUK_PLATE_BOOTS = registerArmorPiece("black_uruk_plate_boots",
            new CustomBootsItem(ModArmorMaterials.BURZUM_STEEL_T5, new Item.Properties(),
                    ModFactions.MORDOR));
    ...
    public static final Item URUK_HAI_MAIL_HAUBERK = registerArmorPiece("uruk_hai_mail_hauberk",
            new CustomChestplateItem(ModArmorMaterials.CRUDE_T3, new Item.Properties(),
                    ModFactions.ISENGARD));

    public static final Item URUK_HAI_MAIL_COAT = registerArmorPiece("uruk_hai_mail_coat",
            new CustomLeggingsItem(ModArmorMaterials.CRUDE_T3, new Item.Properties(),
                    ModFactions.ISENGARD));
    ...
    public static final Item WARG_MORDOR_PLATE_ARMOR = registerGeneratedItem("warg_mordor_plate_armor",
            new CustomAnimalArmorItem(ModArmorMaterials.PLATE, "_mordor", CustomAnimalArmorItem.Type.WARG, false, new Item.Properties().durability(ArmorItem.Type.BODY.getDurability(10)), ModFactions.MORDOR));
    public static final Item WARG_GUNDABAD_PLATE_ARMOR = registerGeneratedItem("warg_gundabad_plate_armor",
            new CustomAnimalArmorItem(ModArmorMaterials.PLATE, "_gundabad", CustomAnimalArmorItem.Type.WARG, false, new Item.Properties().durability(ArmorItem.Type.BODY.getDurability(10)), ModSubFactions.GUNDABAD));
    public static final Item WARG_ISENGARD_PLATE_ARMOR = registerGeneratedItem("warg_isengard_plate_armor",
            new CustomAnimalArmorItem(ModArmorMaterials.PLATE, "_isengard", CustomAnimalArmorItem.Type.WARG, false, new Item.Properties().durability(ArmorItem.Type.BODY.getDurability(10)), ModFactions.ISENGARD));
    public static final Item WARG_MORDOR_MAIL_ARMOR = registerDyeableArmorPiece("warg_mordor_mail_armor",
            new CustomAnimalArmorItem(ModArmorMaterials.MAIL, "_mordor", CustomAnimalArmorItem.Type.WARG, true, new Item.Properties().durability(ArmorItem.Type.BODY.getDurability(6)).component(ModDataComponentTypes.DYE_DATA, new CustomDyeableDataComponent(4865076)), ModFactions.MORDOR));
    public static final Item WARG_LEATHER_ARMOR = registerDyeableArmorPiece("warg_leather_armor",
            new CustomAnimalArmorItem(ModArmorMaterials.LEATHER, null, CustomAnimalArmorItem.Type.WARG, false, new Item.Properties().durability(ArmorItem.Type.BODY.getDurability(4)).component(ModDataComponentTypes.DYE_DATA, new CustomDyeableDataComponent(4865076)), ModFactions.MORDOR));
    public static final Item WARG_REINFORCED_LEATHER_ARMOR = registerDyeableArmorPiece("warg_reinforced_leather_armor",
            new CustomAnimalArmorItem(ModArmorMaterials.LEATHER, "_reinforced", CustomAnimalArmorItem.Type.WARG, true, new Item.Properties().durability(ArmorItem.Type.BODY.getDurability(4)).component(ModDataComponentTypes.DYE_DATA, new CustomDyeableDataComponent(4865076)), ModFactions.MORDOR));

    // Broadhoof Goat
    public static final Item BROADHOOF_GOAT_PADDED_ARMOR = registerDyeableArmorPiece("broadhoof_goat_padded_armor",
            new CustomAnimalArmorItem(ModArmorMaterials.LEATHER, null, CustomAnimalArmorItem.Type.BROADHOOF_GOAT, true, new Item.Properties().durability(ArmorItem.Type.BODY.getDurability(4)).component(ModDataComponentTypes.DYE_DATA, new CustomDyeableDataComponent(15256475)), ModSubFactions.EREBOR));
    public static final Item BROADHOOF_GOAT_ORNAMENTED_PADDED_ARMOR = registerDyeableArmorPiece("broadhoof_goat_ornamented_padded_armor",
            new CustomAnimalArmorItem(ModArmorMaterials.LEATHER, "_ornamented", CustomAnimalArmorItem.Type.BROADHOOF_GOAT, true, new Item.Properties().durability(ArmorItem.Type.BODY.getDurability(4)).component(ModDataComponentTypes.DYE_DATA, new CustomDyeableDataComponent(15256475)), ModSubFactions.EREBOR));
    public static final Item BROADHOOF_GOAT_PLATE_ARMOR = registerGeneratedItem("broadhoof_goat_plate_armor",
            new CustomAnimalArmorItem(ModArmorMaterials.PLATE, null, CustomAnimalArmorItem.Type.BROADHOOF_GOAT, false, new Item.Properties().durability(ArmorItem.Type.BODY.getDurability(10)), ModSubFactions.EREBOR));

    public static final Item HELMET_OF_HELM_HAMMERHAND = registerCustomModelArmorPiece("helmet_of_helm_hammerhand",
            new CustomArtefactHelmetItem(ModArmorMaterials.STEEL_T5, new Item.Properties(),
                    ModFactions.ROHAN));

    private static Item registerItem(String name, Item item) {
        ModItemGroups.EQUIPMENT_CONTENTS.add(item.getDefaultInstance());
