...
public class MiddleEarthFactions {
    ...
    public static final ResourceKey<Registry<Faction>> FACTION_KEY = ResourceKey.createRegistryKey(ResourceLocation.fromNamespaceAndPath(MiddleEarth.MOD_ID, PATH));
    ...
    public static void bootstrap(BootstrapContext<Faction> context) {
        HolderGetter<Faction> factionRegistryEntryLookup = context.lookup(FACTION_KEY);
        // [GONDOR]
    ...
    private static Faction register(BootstrapContext<Faction> context, HolderGetter<Faction> factionRegistryEntryLookup, Faction faction) {
        ResourceKey<Faction> factionRegistryKey = of(faction.getName());
        String name = factionRegistryKey.location().getPath();
        ResourceKey<Faction> factionKey = ResourceKey.create(FACTION_KEY,ResourceLocation.fromNamespaceAndPath(MiddleEarth.MOD_ID,name));

        Optional<Holder.Reference<Faction>> optionalFaction = factionRegistryEntryLookup.get(factionRegistryKey);
    ...
    private static ResourceKey<Faction> of(String name) {
        return ResourceKey.create(FACTION_KEY, ResourceLocation.fromNamespaceAndPath(MiddleEarth.MOD_ID, name));
    }
    ...
    static {
        ...
        GONDOR = new Faction("gondor", true, Disposition.GOOD, FactionType.FACTION, null, null,
                ...
                new SpawnDataHandler(List.of(
                        new SpawnData(ResourceLocation.fromNamespaceAndPath(MiddleEarth.MOD_ID, "gondor.minas_tirith"),  new Vector2d(1945, 1785)),
                        new SpawnData(ResourceLocation.fromNamespaceAndPath(MiddleEarth.MOD_ID, "gondor.anorien"),  new Vector2d(1930, 1735)),
                        new SpawnData(ResourceLocation.fromNamespaceAndPath(MiddleEarth.MOD_ID, "gondor.ithilien"),  new Vector2d(1975, 1700)), // Henneth Annun
                        new SpawnData(ResourceLocation.fromNamespaceAndPath(MiddleEarth.MOD_ID, "gondor.lossarnach"),  new Vector2d(1895, 1792)), // Erui Source
                        new SpawnData(ResourceLocation.fromNamespaceAndPath(MiddleEarth.MOD_ID, "gondor.pelargir"),  new Vector2d(1875, 1960)),
                        new SpawnData(ResourceLocation.fromNamespaceAndPath(MiddleEarth.MOD_ID, "gondor.lamedon"),  new Vector2d(1625, 1800)), // Linhir
                        new SpawnData(ResourceLocation.fromNamespaceAndPath(MiddleEarth.MOD_ID, "gondor.lebennin"),  new Vector2d(1715, 1955)), // Linhir
                        new SpawnData(ResourceLocation.fromNamespaceAndPath(MiddleEarth.MOD_ID, "gondor.ringlo_vale"),  new Vector2d(1530, 1730)), // Calembel
                        new SpawnData(ResourceLocation.fromNamespaceAndPath(MiddleEarth.MOD_ID, "gondor.dol_amroth"),  new Vector2d(1500, 1930))
                    )), List.of(), List.of()
        );
        // endregion
        // region [ROHAN]
        ROHAN = new Faction("rohan", true, Disposition.GOOD, FactionType.FACTION, null,null,
                ...
                new SpawnDataHandler(List.of(
                        new SpawnData(ResourceLocation.fromNamespaceAndPath(MiddleEarth.MOD_ID, "rohan.edoras"), new Vector2d(1525, 1600)),
                        new SpawnData(ResourceLocation.fromNamespaceAndPath(MiddleEarth.MOD_ID, "rohan.helms_deep"), new Vector2d(1470, 1555)), // Westfold
                        new SpawnData(ResourceLocation.fromNamespaceAndPath(MiddleEarth.MOD_ID, "rohan.westemnet"), new Vector2d(1525, 1525)),
                        new SpawnData(ResourceLocation.fromNamespaceAndPath(MiddleEarth.MOD_ID, "rohan.aldburg"), new Vector2d(1600, 1660)), // Eastfold
                        new SpawnData(ResourceLocation.fromNamespaceAndPath(MiddleEarth.MOD_ID, "rohan.eastemnet"), new Vector2d(1715, 1575)),
                        new SpawnData(ResourceLocation.fromNamespaceAndPath(MiddleEarth.MOD_ID, "rohan.the_wold"), new Vector2d(1675, 1475))
                )), List.of(), List.of()
        );
        //endregion
        //region [DALE]
        DALE = new Faction("dale", true, Disposition.GOOD, FactionType.FACTION, null,null,
                ...
                new SpawnDataHandler(List.of(
                        new SpawnData(ResourceLocation.fromNamespaceAndPath(MiddleEarth.MOD_ID, "dale.capital"), new Vector2d(2021, 727)),
                        new SpawnData(ResourceLocation.fromNamespaceAndPath(MiddleEarth.MOD_ID, "dale.esgaroth"), new Vector2d(2007, 757))
                )), List.of(), List.of()
        );
        //endregion
        // region [LONGBEARDS]
        LONGBEARDS = new Faction("longbeards", true, Disposition.GOOD, FactionType.FACTION, null,
                List.of(ResourceLocation.fromNamespaceAndPath(MiddleEarth.MOD_ID, "longbeards.erebor")),
        ...
        LONGBEARDS_EREBOR = new Faction(LONGBEARDS.getName().concat(".erebor"), true, Disposition.GOOD, FactionType.SUBFACTION, LONGBEARDS.getId(),null,
                ...
                new SpawnDataHandler(List.of(
                        new SpawnData(ResourceLocation.fromNamespaceAndPath(MiddleEarth.MOD_ID, LONGBEARDS.getName().concat(".erebor.ravenhill")), new Vector2d(2017, 722)),
                        new SpawnData(ResourceLocation.fromNamespaceAndPath(MiddleEarth.MOD_ID, LONGBEARDS.getName().concat(".erebor.iron_hills")), new Vector2d(2355, 725)),
                        new SpawnData(ResourceLocation.fromNamespaceAndPath(MiddleEarth.MOD_ID, LONGBEARDS.getName().concat(".erebor.iron_hills_spring")), new Vector2d(2262, 782))
                )), List.of(), List.of()
        );
        ...
        LOTHLORIEN = new Faction("lothlorien", true, Disposition.GOOD, FactionType.FACTION, null, null,
                ...
                new SpawnDataHandler(List.of(
                        new SpawnData(ResourceLocation.fromNamespaceAndPath(MiddleEarth.MOD_ID, "lothlorien.cerin_amroth"), new Vector2d(1614, 1215))
                )), List.of(), List.of()
        );
        // endregion
        //region [MORDOR]
        MORDOR = new Faction("mordor", true, Disposition.EVIL, FactionType.FACTION, null,null,
                ...
                new SpawnDataHandler(List.of(
                        new SpawnData(ResourceLocation.fromNamespaceAndPath(MiddleEarth.MOD_ID, "mordor.gorgoroth"), new Vector2d(2161, 1717)),
                        new SpawnData(ResourceLocation.fromNamespaceAndPath(MiddleEarth.MOD_ID, "mordor.black_gates"), new Vector2d(2010, 1608)),
                        new SpawnData(ResourceLocation.fromNamespaceAndPath(MiddleEarth.MOD_ID, "mordor.minas_morgul"), new Vector2d(2029, 1770)),
                        new SpawnData(ResourceLocation.fromNamespaceAndPath(MiddleEarth.MOD_ID, "mordor.nurn"), new Vector2d(2345, 1915)),
                        new SpawnData(ResourceLocation.fromNamespaceAndPath(MiddleEarth.MOD_ID, "mordor.dol_guldur"), new Vector2d(1793, 1210))
                )), List.of(), List.of()
        );
        //endregion
        ...
        MISTY_MOUNTAINS_GOBLINS = new Faction("misty_mountains_goblins", true, Disposition.EVIL, FactionType.FACTION, null,null,
                ...
                new SpawnDataHandler(List.of(
                    new SpawnData(ResourceLocation.fromNamespaceAndPath(MiddleEarth.MOD_ID, "misty_mountains_goblins.gundabad"), new Vector2d(1595, 640)),
                    new SpawnData(ResourceLocation.fromNamespaceAndPath(MiddleEarth.MOD_ID, "misty_mountains_goblins.grey_mountains"), new Vector2d(1652, 640)),
                    new SpawnData(ResourceLocation.fromNamespaceAndPath(MiddleEarth.MOD_ID, "misty_mountains_goblins.goblin_town"), new Vector2d(1581.5, 874.5)),
                    new SpawnData(ResourceLocation.fromNamespaceAndPath(MiddleEarth.MOD_ID, "misty_mountains_goblins.moria"), new Vector2d(1521, 1138))
                )), List.of(), List.of()
        );
        // endregion
        // region [ISENGARD]
        ISENGARD = new Faction("isengard", true, Disposition.EVIL, FactionType.FACTION, null,null,
            ...
            new SpawnDataHandler(List.of(
                    new SpawnData(ResourceLocation.fromNamespaceAndPath(MiddleEarth.MOD_ID, "isengard.orthanc"), new Vector2d(1402, 1467))
            )), List.of(), List.of()
        );
        // endregion
        //region [SHIRE]
        SHIRE = new Faction("shire", true, Disposition.GOOD, FactionType.FACTION, null,null,
                ...
                new SpawnDataHandler(List.of(
                        new SpawnData(ResourceLocation.fromNamespaceAndPath(MiddleEarth.MOD_ID, "shire.hobbiton"), new Vector2d(933, 900)),
                        new SpawnData(ResourceLocation.fromNamespaceAndPath(MiddleEarth.MOD_ID, "shire.willowbottom"), new Vector2d(981, 970))
                )), List.of(), List.of()
        );
        //endregion
        //region [BANDITS]
