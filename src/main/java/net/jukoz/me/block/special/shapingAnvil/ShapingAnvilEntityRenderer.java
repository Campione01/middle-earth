...
public class ShapingAnvilEntityRenderer implements BlockEntityRenderer<TreatedAnvilBlockEntity> {
    ...
    @Override
    public void render(TreatedAnvilBlockEntity entity, float tickDelta, PoseStack matrices,
        ...
        if (stack.getItem() instanceof BlockItem){
            switch (entity.getBlockState().getValue(AbstractTreatedAnvilBlock.FACING)) {
