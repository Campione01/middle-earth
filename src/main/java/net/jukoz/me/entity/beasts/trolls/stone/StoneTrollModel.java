...
public class StoneTrollModel extends HierarchicalModel<StoneTrollEntity> {
    ...
    @Override
    public void setupAnim(StoneTrollEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        this.root().getAllParts().forEach(ModelPart::resetPose);
        this.setHeadAngles(headYaw, headPitch);

        this.animateWalk(StoneTrollAnimations.WALK, limbAngle, limbDistance, 3f, 3f);
        this.animate(entity.attackAnimationState, StoneTrollAnimations.ATTACK, animationProgress, 1.3f);
        this.animate(entity.chargeAnimationState, StoneTrollAnimations.CHARGE, animationProgress, 1f);
        this.animate(entity.throwingAnimationState, StoneTrollAnimations.THROW, animationProgress, 1f);
        this.animate(entity.sittingAnimationState, StoneTrollAnimations.SITTING, animationProgress, 1f);
    }
