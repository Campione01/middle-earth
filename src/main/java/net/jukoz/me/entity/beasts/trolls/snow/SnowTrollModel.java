...
public class SnowTrollModel extends HierarchicalModel<SnowTrollEntity> {
    ...
    @Override
    public void setupAnim(SnowTrollEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        this.root().getAllParts().forEach(ModelPart::resetPose);
        this.setHeadAngles(netHeadYaw, headPitch);

        this.animateWalk(SnowTrollAnimations.WALKING, limbSwing, limbSwingAmount, 1f, 1f);
        //this.updateAnimation(entity.idleAnimationState, SnowTrollAnimations.IDLE, ageInTicks, 1f);
        this.animate(entity.attackAnimationState, SnowTrollAnimations.ATTACK, ageInTicks, 1.4f);
        this.animate(entity.chargeAnimationState, SnowTrollAnimations.CHARGING, ageInTicks, 1f);
        this.animate(entity.throwingAnimationState, SnowTrollAnimations.THROWING, ageInTicks, 1.2f);
    }
