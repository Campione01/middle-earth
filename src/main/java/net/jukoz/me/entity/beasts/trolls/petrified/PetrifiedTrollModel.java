...
import net.jukoz.me.entity.beasts.trolls.stone.StoneTrollAnimations;
...
public class PetrifiedTrollModel extends HierarchicalModel<PetrifiedTrollEntity> {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition cube1 = club.addOrReplaceChild("cube1", CubeListBuilder.create().texOffs(16, 158).mirror().addBox(-4.5F, -4.5F, -22.0F, 9.0F, 9.0F, 22.0F, new CubeDeformation(0.0F)).mirror(false)
    ...
    @Override
    public void setupAnim(PetrifiedTrollEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
